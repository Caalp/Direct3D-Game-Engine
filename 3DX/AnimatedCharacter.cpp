...
AnimatedCharacter::AnimatedCharacter(Graphics& gfx, const std::string& filename, const std::string& modelName) : m_cbBoneTransforms(gfx, m_finalTransforms.finalTransforms, m_finalTransforms.finalTransforms.size(),2u)
{
