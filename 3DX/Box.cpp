...
//		Technique boxDefault("boxDefault", channel1::defaultChannel,true);
//		{
//			{
//
//				Step s1{ "default" };
...
//				mID3 = std::move(entt->GetID());
//				//
//
//				s1.AddBind(std::make_shared<DrawIndexed>(0, indexBuffer.get()->GetIndexCount()));
//				s1.AddBind(std::make_shared<TransformationBuffer>(gfx, mID3));
...
//		Technique boxReflection("boxReflection", channel1::defaultChannel,true);
//		{
//
//			{
