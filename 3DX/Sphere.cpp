...
Sphere::Sphere(std::string name, float radius, unsigned int sliceCount, unsigned int stackCount)
{
	...
	v.Normal = MathUtils::normalize(v.Pos);
...
//		s1.AddBind(std::make_shared<Texture>(gfx, "../Textures/stone.dds"));
