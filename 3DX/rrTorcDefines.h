...
#define TORC_ALPHA_TO_COVERAGE_ENABLE				UINT64_C(0x0000000004000000)
#define TORC_ALPHA_TO_COVERAGE_DISABLE				UINT64_C(0x0000000000000000)
#define TORC_ALPHA_TO_COVERAGE_MASK					UINT64_C(0x0000000004000000)
#define TORC_ALPHA_TO_COVERAGE_SHIFT				26
...
#define TORC_INDEPENDENT_BLEND_ENABLE				UINT64_C(0x0000000100000000)
#define TORC_INDEPENDENT_BLEND_DISABLE				UINT64_C(0x0000000000000000)
#define TORC_INDEPENDENT_BLEND_MASK					UINT64_C(0x0000000100000000)
#define TORC_INDEPENDENT_BLEND_SHIFT				32


// Rasterizer state fields
// fill modes
#define TORC_STATE_FILL_WIREFRAME					UINT64_C(0x0000000000000000)
#define TORC_STATE_FILL_SOLID						UINT64_C(0x0000000020000000)
#define TORC_STATE_FILL_MASK						UINT64_C(0x0000000020000000)
#define TORC_STATE_FILL_SHIFT						32

// cull modes
#define TORC_STATE_CULL_NONE						UINT64_C(0x0000000040000000)
#define TORC_STATE_CULL_FRONT						UINT64_C(0x0000000080000000)
#define TORC_STATE_CULL_BACK						UINT64_C(0x00000000C0000000)
#define TORC_STATE_CULL_MASK						UINT64_C(0x00000000C000000)
#define TORC_STATE_CULL_SHIFT						32


// cull direction
#define TORC_STATE_FRONT_CCW						UINT64_C(0x0000000000000000)
#define TORC_STATE_FRONT_CW							UINT64_C(0x0000000100000000)
#define TORC_STATE_FRONT_CULL_MASK					UINT64_C(0x0000000100000000)
#define TORC_STATE_FRONT_CULL_SHIFT					36

// depth clip setting
#define TORC_STATE_DEPTH_CLIP_ENABLE				UINT64_C(0x0000000200000000)
#define TORC_STATE_DEPTH_CLIP_DISABLE				UINT64_C(0x0000000000000000)
#define TORC_STATE_DEPTH_CLIP_MASK					UINT64_C(0x0000000200000000)
#define TORC_STATE_DEPTH_CLIP_SHIFT					36

// scissor 
#define TORC_STATE_SCISSOR_ENABLE					UINT64_C(0x0000000400000000)
#define TORC_STATE_SCISSOR_DISABLE					UINT64_C(0x0000000000000000)
#define TORC_STATE_SCISSOR_MASK						UINT64_C(0x0000000400000000)
#define TORC_STATE_SCISSOR_SHIFT					36


// msaa 
#define TORC_STATE_MSAA_ENABLE						UINT64_C(0x0000000800000000)
#define TORC_STATE_MSAA_DISABLE						UINT64_C(0x0000000000000000)
#define TORC_STATE_MSAA_MASK						UINT64_C(0x0000000800000000)
#define TORC_STATE_MSAA_SHIFT						36

// aa
#define TORC_STATE_AA_LINE_ENABLE					UINT64_C(0x0000001000000000)
#define TORC_STATE_AA_LINE_DISABLE					UINT64_C(0x0000000000000000)
#define TORC_STATE_AA_LINE_MASK						UINT64_C(0x0000001000000000)
#define TORC_STATE_AA_LINE_SHIFT					40

//depth comp functions
// 3 bits for depth comparison functions 
/* ***0 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000*/
#define TORC_STATE_COMPARISON_NEVER					UINT64_C(0x0000000000000000)
...
#define TORC_STATE_COMPARISON_ALWAYS				UINT64_C(0x00000E0000000000)
...
#define TORC_STATE_DEPTH_WRITE_MASK_ZERO			UINT64_C(0x0000000000000000)
#define TORC_STATE_DEPTH_WRITE_MASK_ALL				UINT64_C(0x0000100000000000)
...
#define TORC_STATE_STENCIL_DESC(frontFace, backFace)
...
#define TORC_BLEND_EQUATION(rgbEq, alphaEq)			(((uint64_t)rgbEq << 10) | ((uint64_t)alphaEq << 23))
	...
	typedef struct TORC_BLEND_STATE_DESC
	{
		bool AlphaToCoverageEnable;
		bool IndependentBlendEnable;

	} TORC_BLEND_STATE_DESC;

	typedef	enum TORC_STENCIL_OP
	{
		TORC_STENCIL_OP_KEEP = 1,
		TORC_STENCIL_OP_ZERO = 2,
		TORC_STENCIL_OP_REPLACE = 3,
		TORC_STENCIL_OP_INCR_SAT = 4,
		TORC_STENCIL_OP_DECR_SAT = 5,
		TORC_STENCIL_OP_INVERT = 6,
		TORC_STENCIL_OP_INCR = 7,
		TORC_STENCIL_OP_DECR = 8
	} 	TORC_STENCIL_OP;
	typedef struct TORC_DEPTH_STENCILOP_DESC
	{
		TORC_STENCIL_OP StencilFailOp;
		TORC_STENCIL_OP StencilDepthFailOp;
		TORC_STENCIL_OP StencilPassOp;
		//TORC_COMPARISON_FUNC StencilFunc;
	} 	TORC_DEPTH_STENCILOP_DESC;
	typedef struct TORC_DEPTH_STENCIL_STATE_DESC
	{
		/*bool DepthEnable;
		TORC_DEPTH_WRITE_MASK DepthWriteMask;
		TORC_COMPARISON_FUNC DepthFunc;*/
		bool StencilEnable;
		uint8_t StencilReadMask;
		uint8_t StencilWriteMask;
		TORC_DEPTH_STENCILOP_DESC FrontFace;
		TORC_DEPTH_STENCILOP_DESC BackFace;
	}TORC_DEPTH_STENCIL_STATE_DESC;
